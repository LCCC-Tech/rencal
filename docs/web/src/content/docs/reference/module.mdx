...
description: A page to as a template for PyDoc pages.
draft: true
---
...
```python
class FormatSpecifier(param1: float) -> pd.DataFrame
```
...
```python
class FormatSpecifier(param1: float, param2: str, param3: bool) -> pd.DataFrame
```
...
```python
class FormatSpecifier(specifier: FormatSpecifierObject, addend: float | str | bool): FormatSpecifier
```
</Section>
...
<Section type="signature">
```python
def simple_args(is_true: bool, is_false: bool, is_any: bool) -> None:
    pass
```
</Section>
...
- <p><code class="key">is_true</code> <code class="primitive">bool</code></p>
- <p><code class="key">is_false</code> <code class="primitive">bool</code></p>
- <p><code class="key">is_any</code> <code class="primitive">bool</code></p>
</Section>
...
<Section type="signature">
```python
def full_args(prop1: bool = True, prop2: str = "x86_64", prop3: Optional[List[FormatSpecifier]] = None) -> Optional[List[FormatSpecifier]]:
    pass
```
</Section>
...
- <p><code class="key">prop1</code> <code class="primitive">bool</code></p>
...
- <p><code class="key">prop2</code> <code class="primitive">str</code></p>
...
- <p><code class="key">prop3</code> <code class="primitive">Optional[List[FormatSpecifier]]</code></p>
...
<InlineSection>
**Returns** <code class="primitive">Optional[List[FormatSpecifier]]</code>
</InlineSection>
...
```python
def demo():
    return full_args(True, False, True)
```
